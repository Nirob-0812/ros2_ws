...
def generate_launch_description():
    ...
    scan_mode = LaunchConfiguration('scan_mode', default='Standard')  # ✅ use known working mode
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('inverted', default_value=inverted,
                              description='Specifying whether to invert scan data'),
        ...
        DeclareLaunchArgument('scan_mode', default_value=scan_mode,
                              description='Specifying scan mode (Standard/Express etc.)'),
